...
from schemas import DeepSeekClient, MergedStyle, OUTLINE_LABELS, PipelineResult
    ...
    try:
        ...
        for ms in merged:
            print(f"  {ms.style_id}: "
                  ...
                  f"firstIndent={ms.first_line_chars}, "
                  f"before={ms.space_before_twips}, "
                  f"after={ms.space_after_twips}")
